####################################################################################################################################################
# Script Name      : main.py (Synthetic Data Generater + )
# Script Details   : This is a script that generates mock data.
#
# usage            : main.py [-h] [-c {m,e,g}] volume {csv,parquet} csv_file [conf_csv_file]
#
...
# ==================================================================================================================================================
#     2023-09-06                            Damodhar Jangam (damodhar918)                          Initial Creation
####################################################################################################################################################
import pandas as pd
import numpy as np
import hashlib
